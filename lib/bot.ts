...
export const bot = new Bot(Deno.env.get("BOT_TOKEN") || "7864266027:AAGJL9Dm7MK-GrBj_iRoTd_3wE1u5q-_lZw"); // export нужен, чтобы воспользоваться ботом в другом файле
